...
@Component({
  templateUrl: "./addpproduct.component.html",
  styleUrls: []
})
@Injectable()
export class addpproduct implements OnInit, OnDestroy {
  ...
  // insertData() {
  //   this.api
  //     .insertSellerProduct(this.addProduct)
  ...
  constructor(
    private dialogRef: MatDialogRef<addpproduct>,
