...
module.exports = (app, knex, acl) => {
    ...
    /**
     * @apiVersion 1.0.0
     * @api {post} /api/updatesellerStatus
     * @apiName updatesellerStatus
     * @apiGroup status
     *
     *
    ...
    app.post('/api/updatesellerStatus', handler.asyncFn(async (req, res, next) => {
        let results = await updatesellerStatusQuery(req.body, null)
        res.send(JSON.stringify(results));
    }));

    const updatesellerStatusQuery = async (sellerProduct, transaction) => {
    ...
    app.locals.services.updatesellerStatusQuery = updatesellerStatusQuery;
};